---
name: fix
description: 보안 취약점 자동 수정 및 하드닝 스크립트를 생성합니다. CII 시스템(Unix/Windows/웹서버/DB)과 AI 시스템의 취약점을 수정합니다. KISA 가이드라인에 따른 보안 설정을 적용합니다. "취약점 수정", "시스템 보안", "서버 하드닝", "보안 수정", "AI 보안 조치", "KISA 하드닝" 시 반드시 이 스킬을 사용하세요.
---
...
서버, 인프라, 웹 서비스, DB → **CII** / AI 모델, LLM, AI 서비스 → **AI 보안**
